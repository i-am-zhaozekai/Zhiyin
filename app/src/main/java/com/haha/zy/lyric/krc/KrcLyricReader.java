...
import com.haha.zy.lyric.model.TranslateLyricsInfo;
import com.haha.zy.lyric.model.TransliterationLyricsInfo;
...
public class KrcLyricReader implements LyricReader {
    ...
    public LyricsInfo readInputStream(InputStream in) throws Exception {
        ...
        if (in != null) {
            ...
            String lyricsTextStr = StringCompressUtils.decompress(zip_byte, defaultCharset);
    ...
    private LyricsLineInfo parserLineInfos(Map<String, Object> lyricsTags,
        ...
        if (lineInfo.startsWith(LEGAL_SONGNAME_PREFIX)) {
            ...
            //
            lyricsTags.put(LyricTag.TAG_TITLE,
