package com.haha.zy.audio.reader.mp3;
...
public class MP3FileReader extends AudioFileReader {
    ...
    protected static final Charset DEFAULT_CHARTSET = Charset.forName("iso8859-1");

    public TrackInfo readSingle(TrackInfo trackInfo) {
        TextEncoding.getInstanceOf().setDefaultNonUnicode(DEFAULT_CHARTSET.name());
        ID3Tag.setDefaultEncoding(DEFAULT_CHARTSET.name());
