...
public class LrcSeekBar extends AppCompatSeekBar {
    ...
    private int backgroundProgressColor = 0xFFE5E5E5;

    private Paint progressPaint;
    private int progressColor = 0xFF76C8FA;

    private Paint secondProgressPaint;
    private int secondProgressColor = 0xFFD4D4D4;

    private Paint thumbPaint;
    private int thumbColor = 0xFF76C8FA;
    ...
    private int mTimePopupWindowViewColor = ColorUtils.setAlphaComponent(0xFF76C8FA, 180);
    ...
    private int mTimeAndLrcPopupWindowViewColor = ColorUtils.setAlphaComponent(0xFF76C8FA, 180);
    /**
     * 时间提示
     */
