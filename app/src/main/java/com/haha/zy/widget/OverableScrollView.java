...
public class OverableScrollView extends ScrollView{
    ...
    public OverableScrollView(Context context) {
        super(context);
        init(context);
    }

    public OverableScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public OverableScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

    public OverableScrollView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
