...
import com.haha.zy.net.entity.SearchArtistPicResult;
...
public class SearchArtistPicUtil {
     ...
     * @throws Exception
     */
    public static List<SearchArtistPicResult> searchArtistPic(Context context, String singerName,
                                                              String width, String height, String type) {
